...
public class lab6 extends GLJPanel implements GLEventListener 
{
	...
	public void Base(GL2 gl2, int n, int r) 
	{
		gl2.glBegin(GL2.GL_POLYGON);
		for (int i = 0; i <= n; i++) 
		{
			gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, materials[7], 2);
			gl2.glVertex3d((double) (r * Math.cos(2 * i * Math.PI / n)), 1, (double) (r * Math.sin(2 * i * Math.PI / n)));
		}
		gl2.glEnd();
	}

	public void Polygon(GL2 gl2, int n, int r, int h) 
	{
		Base(gl2, n, r);
		for (int i = 0; i <= n; i++) 
		{
			gl2.glBegin(GL2.GL_POLYGON);
			gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, materials[7], 4);
			gl2.glVertex3d((double) (r * Math.cos(2 * i * Math.PI / n)), 1, (double) (r * Math.sin(2 * i * Math.PI / n)));
			gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, materials[7], 7);
			gl2.glVertex3d(0, h, 0);
			i++;

			gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, materials[7], 8);
